...
def run(rank, local_rank, world_size, args):
    ...
    ep_model = apply_expert_parallelism(copy.deepcopy(model), dist.group.WORLD)
    ...
    assert_gradients_are_the_same(ep_model, world_size, rank, except_patterns=["moe.experts.mlp"])
